...
})()(
  {
    1: [
          ...
          try {
            ...
            ws.onclose = function (event) {
              ...
              setTimeout(function () {
                ...
                document.getElementById("counterbar1sub").style.display =
                  "none";
                document.getElementById("counterbar2sub").style.display =
                  "none";
              }, 2000);
              ...
              setTimeout(function () {
                ...
                backColorArray = new Array(latencyValues.length).fill(
                  "lightgray"
                );
      ...
      },
      {
        "./rtc.config": 16,
        "progressbar.js": 4,
        "webrtc-server-client-datachannel": 11,
      },
    ],
    2: [
      function (require, module, exports) {
            ...
            var t = {
                720: function (t, n, e) {
                  ...
                  var $,
                    ...
                    ct = function (t, n) {
                      ...
                      if (!(n < e + i)) {
                        ...
                        l && t._applyFilter(Z),
                          s < e + i ? (e = u = s = 1) : (e += i),
                          st(s, r, t._originalState, o, u, e, t._easing),
                          l && t._applyFilter(X),
                  ...
                  function Qt(t) {
                    ...
                    [n, t._originalState, t._targetState].forEach(Ft),
                  ...
                  function zt(t) {
                    for (var n = 1; n < arguments.length; n++) {
                      var e = null != arguments[n] ? arguments[n] : {};
                      n % 2
                        ? Rt(Object(e), !0).forEach(function (n) {
                            Lt(t, n, e[n]);
                          })
                        : Object.getOwnPropertyDescriptors
                        ? Object.defineProperties(
                        ...
                        : Rt(Object(e)).forEach(function (n) {
                            Object.defineProperty(
                              t,
                              n,
                              Object.getOwnPropertyDescriptor(e, n)
                  ...
                  var Ut = new _t(),
                    ...
                    Wt = function (t, n, e, r) {
                      var i =
                        ...
                        u = zt({}, t),
                        o = ht(t, r);
                      for (var a in ((Ut._filters.length = 0),
                      Ut.set({}),
                      (Ut._currentState = u),
                      (Ut._originalState = t),
                      (Ut._targetState = n),
                      ...
                      Ut._applyFilter("tweenCreated"),
                        Ut._applyFilter("beforeTween");
                      ...
                      var u = (function (t, n, e, r) {
                        return function (i) {
                          return (
                            ...
                            (f = 1 - (h = 3 * (u = t)) - (l = 3 * (e - u) - h)),
                            (a = 1 - (c = 3 * (o = n)) - (s = 3 * (r - o) - c)),
                            (function (t) {
                              return ((a * t + s) * t + c) * t;
                            })(
                              (function (t, n) {
    ...
    11: [
      ...
      { "./src/RTCClient": 13, "./src/RTCServer": 14 },
    ],
    12: [
      function (require, module, exports) {
        "use strict";
        ...
        module.exports.Rtcpc = class Rtcpc {
          ...
          constructor(ws, config, datachannels) {
            ...
            this.datachannels.forEach((element) => {
              ...
              this[element.label] = this.pc.createDataChannel(
                element.label,
                element.config
              );
      ...
      function (require, module, exports) {
        module.exports.rtcConfig = {
          RTCPeerConnectionConf: {
            ...
            ], //Apparently this may make firefox compatible.
          },
          datachannels: [
            {
              label: "tcp",
